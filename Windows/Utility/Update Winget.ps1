...
$strDownloadURL = "https://github.com/microsoft/winget-cli/releases/download/v$($targetVersion.ToString())/Microsoft.DesktopAppInstaller_8wekyb3d8bbwe.msixbundle"
