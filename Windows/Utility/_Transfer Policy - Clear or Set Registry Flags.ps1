...
function funcSetRegistryFlags(){
    ...
    if (Test-Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon" -ErrorAction SilentlyContinue) {
        if (-not (Test-Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -ErrorAction SilentlyContinue)) { #PRIVATE
    ...
    if($strARegistryFlags['DO'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "DO" -ErrorAction SilentlyContinue
    } 
    ...
    if($strARegistryFlags['CT'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CT" -ErrorAction SilentlyContinue
    }
    

    if($strARegistryFlags['BT'] -eq '1'){
        Set-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "BT" -Value "1" -Type "String" -ErrorAction SilentlyContinue -Force
    }
    if($strARegistryFlags['BT'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "BT" -ErrorAction SilentlyContinue
    }
    

    if($strARegistryFlags['CL'] -eq '1'){
        Set-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CL" -Value "1" -Type "String" -ErrorAction SilentlyContinue -Force
    }
    if($strARegistryFlags['CL'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CL" -ErrorAction SilentlyContinue
    }
    ...
    if($strARegistryFlags['TI'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "TI" -ErrorAction SilentlyContinue
    }
    

    if($strARegistryFlags['CVL'] -eq '1'){
        Set-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CVL" -Value "1" -Type "String" -ErrorAction SilentlyContinue -Force
    }
    if($strARegistryFlags['CVL'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CVL" -ErrorAction SilentlyContinue
    }
    

    if($strARegistryFlags['END'] -eq '1'){
        Set-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "END" -Value "1" -Type "String" -ErrorAction SilentlyContinue -Force
    }
    if($strARegistryFlags['END'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "END" -ErrorAction SilentlyContinue
    }
    

    if($strARegistryFlags['DPS'] -eq '1'){
        Set-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "DPS" -Value "1" -Type "String" -ErrorAction SilentlyContinue -Force
    }
    if($strARegistryFlags['DPS'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "DPS" -ErrorAction SilentlyContinue
    }
    ...
    if($strARegistryFlags['RDI'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "RDI" -ErrorAction SilentlyContinue
    }
    ...
    if($strARegistryFlags['SDI'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "SDI" -ErrorAction SilentlyContinue
    }
    ...
    if($strARegistryFlags['CDBG'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "CDBG" -ErrorAction SilentlyContinue
    }
    ...
    if($strARegistryFlags['SBE'] -eq '0'){
        Remove-ItemProperty -Path "$strPath\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name "SBE" -ErrorAction SilentlyContinue
    }
