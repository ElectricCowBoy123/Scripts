...
if($strDPSVal -ne '1'){
    ...
    New-ItemProperty -Path "Registry::HKEY_USERS\$strUserSID\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name 'DPS' -PropertyType 'String' -Value '1' -ErrorAction SilentlyContinue
    exit 0
}
if($strDPSVal -eq '1'){
