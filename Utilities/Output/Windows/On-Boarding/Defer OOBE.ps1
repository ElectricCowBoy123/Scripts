...
if($strDOVal -ne '1'){
    ...
    New-ItemProperty -Path "Registry::HKEY_USERS\$strUserSID\Software\Microsoft\Windows NT\CurrentVersion\Winlogon\TST" -Name 'DO' -PropertyType 'String' -Value '1' -ErrorAction SilentlyContinue
    exit 0
}
